...
# # Email Entry
# emailid = Entry(frame, width=25, font=('Microsoft yaHei UI Light', 11))
...
# signup = Button(frame, width=20, text='Sign up', command=sign_up, padding='7')
# signup.place(x=100, y=234)

# label = Label(frame, text="Already have an account ?", font=('Microsoft yaHei UI Light', 9))
# label.place(x=60, y=300)
# label.bind("<Button-1>", navigate_to_login)

# login = Label(frame, width=8, text='Login', font=('Microsoft yaHei UI Light', 8))
# login.place(x=210, y=300)
