...
# def navigate_to_signup(event):
#     # Place your code here to navigate to the signup page
...
# frame = Frame(root, width=350, height=350, bootstyle="dark")
# frame.place(x=480, y=70)

# heading = Label(frame, text='Sign in', font=('Microsoft YaHei UI Light', 23, 'bold'))
...
# code = Entry(frame, width=25, font=('Microsoft yaHei UI Light', 11), show='*')
...
# show_password_icon = Label(frame, image=show_password_icon_image)
...
# signin = Button(frame, width=20, text='Sign in', command=sign_in, padding='7')
# signin.place(x=100, y=184)

# label = Label(frame, text="Don't have an account ?", font=('Microsoft yaHei UI Light', 9))
# label.place(x=60, y=250)
# label.bind("<Button-1>", navigate_to_signup)

# sign_up = Label(frame, width=8, text='Sign up', font=('Microsoft yaHei UI Light', 8))
# sign_up.place(x=210, y=250)
...
# sign_up_button = Button(frame, width=7, text='Sign up', command=sign_up)
